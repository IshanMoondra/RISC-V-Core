...
if __name__ == "__main__":
    ...
    parser.add_argument("-byte", type=int, choices=[0,1], default=0, help="Byte mode (1 for byte-wide LE, 0 for word-wide)")
    
    args = parser.parse_args()
    convert_bin_to_hex(args.input_file, args.output, byte_mode=bool(args.byte))
