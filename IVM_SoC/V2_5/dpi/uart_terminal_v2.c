...
// // -----------------------------------------------------------------------------
// // RX Line buffer for terminal-like behavior
// // -----------------------------------------------------------------------------
// #define LINE_BUF_SIZE 256
// static char rx_line_buf[LINE_BUF_SIZE];
// static int  rx_line_len = 0;

// // -----------------------------------------------------------------------------
// // Updated UART control outputs
// // -----------------------------------------------------------------------------
// void dpi_uart_get_ctrl_outputs_v2(
//     svBit *clr_rx_rdy,
//     int   *tx_buffer,
...
//             // Normal ASCII: accumulate into line buffer
//             else {
//                 if (b == '\n') {
//                     rx_line_buf[rx_line_len] = 0;
//                     if (rx_line_len > 0)
//                         printf("\n[GOT LINE]: %s", rx_line_buf);
//                     rx_line_len = 0;
//                     fflush(stdout);
//                 }
//                 else if (b == '\r') {
//                     // Ignore or could reset line for \r behavior
//                 }
//                 else if (b == '\b') {
//                     if (rx_line_len > 0) rx_line_len--; // handle backspace
//                 }
//                 else {
//                     if (rx_line_len < LINE_BUF_SIZE - 1)
//                         rx_line_buf[rx_line_len++] = (char)b;
//                 }
//             }
//         }
//         else if (uart_mode == UART_MODE_WAIT_LEN) {
