...
report_power -analysis_effort high > ./Reports/${DESIGN_NAME}_GF22_power.rpt
report_area > ./Reports/${DESIGN_NAME}_GF22_area.rpt
report_timing -delay max > ./Reports/${DESIGN_NAME}_GF22_timing_max.rpt
report_timing -delay min > ./Reports/${DESIGN_NAME}_GF22_timing_min.rpt
